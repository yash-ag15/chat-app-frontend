      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="flex justify-center py-8">
          <div className="w-36 h-36 rounded-full flex items-center justify-center"
            ...
            <span className="text-5xl font-light" style={{ color: "hsl(0 0% 35%)" }}>J</span>
          </div>
        </div>
        ...
        <div className="mx-4 rounded-xl p-4 mb-2"
          ...
          <div className="flex justify-between items-center">
            <p className="text-base font-medium" style={{ color: "hsl(0 0% 10%)" }}>JohnDoe</p>
            <button style={{ color: "hsl(0 0% 55%)" }}
        ...
        <div className="mx-4 rounded-xl p-4"
          ...
          <div className="flex justify-between items-center">
            <p className="text-base" style={{ color: "hsl(0 0% 10%)" }}>Hey there! I'm using ChatHub</p>
            <button style={{ color: "hsl(0 0% 55%)" }}
              onMouseEnter={(e) => e.currentTarget.style.color = "hsl(0 0% 20%)"}
              onMouseLeave={(e) => e.currentTarget.style.color = "hsl(0 0% 55%)"}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
