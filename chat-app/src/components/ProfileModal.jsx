                    ...
                    <>
                        ...
                        {profileType === "GROUP" && profileData && (
                            <div >
                                ...
                                {/*  IMAGE / PREVIEW */}
                                <div className="mb-2 relative group w-20 h-20 mx-auto">
                                    ...
                                    <label className="absolute inset-0 z-10 bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center cursor-pointer transition-opacity duration-200 rounded-full">
                                ...
                                {showSave && (
                                    <div className="text-center mt-2 space-x-2">
                                        ...
                                        <button
                                            ...
                                            className="text-xs text-gray-500 bg hover:bg-gray-300"
                                        >
                                            Cancel
                                        </button>
                                    </div>
